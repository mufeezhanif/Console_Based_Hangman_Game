...
{				
	...
	memset(body, ' ', (CHANCE+1)*sizeof(char)); //fill each body char with space
	memset(guessed, '_', len);  //fill each guessed char with _
...
// to select a random word from array
int rnd_index(int i) 
{
     if (word_select==0) 
	 {
